var datebase = {
          ...
          technical_skills: {
                    languages: [
                              "Proficient in: Bootstrap, HTML5, CSS3, JavaScript, jQuery, JSON, C, C++.",
                              "Moderate in: PHP"
                    ],
                    software_t: [
                              "Database: SQL Server",
                              "Platforms: Microsoft Windows and Linux.",
                              "Others: Microsoft Office, Adobe Photoshop & Dreamweaver."
                    ],
                    hardware: [
                              "Computer assembling and all types of software installation."
                    ]
          },
