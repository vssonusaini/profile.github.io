  ...
  return (
    ...
    (o.m = e =
      [
        ...
        function (t, r) {
          t.exports = { render: "image", crisp: !0, minVersion: 1, ecLevel: "L", size: 200, ratio: null, fill: "#333", back: "#fff", text: "no text", rounded: 0, quiet: 0, mode: "plain", mSize: 30, mPosX: 50, mPosY: 50, label: "no label", fontname: "sans", fontcolor: "#333", image: null };
        },
        function (t, r, e) {
          function u(t) {
            return (u =
            ...
            a = (function () {
              function i(t, r) {
                ...
                var u = t,
                  ...
                  h = {},
                  e = function (t, r) {
                    for (var e = -1; e <= 7; e += 1) if (!(t + e <= -1 || s <= t + e)) for (var n = -1; n <= 7; n += 1) r + n <= -1 || s <= r + n || (l[t + e][r + n] = (0 <= e && e <= 6 && (0 == n || 6 == n)) || (0 <= n && n <= 6 && (0 == e || 6 == e)) || (2 <= e && e <= 4 && 2 <= n && n <= 4));
                  },
                  o = function () {
                  ...
                  i = function () {
                    for (var t = m.getPatternPosition(u), r = 0; r < t.length; r += 1)
                      for (var e = 0; e < t.length; e += 1) {
                        var n = t[r],
                          o = t[e];
                        if (null == l[n][o]) for (var i = -2; i <= 2; i += 1) for (var a = -2; a <= 2; a += 1) l[n + i][o + a] = -2 == i || 2 == i || -2 == a || 2 == a || (0 == i && 0 == a);
                      }
                  },
                  g = function (t) {
                  ...
                  p = function (t, r, e) {
                    ...
                    return (function (t, r) {
                      ...
                      for (var v = new Array(d), p = 0, l = 0; l < n; l += 1) for (u = 0; u < r.length; u += 1) l < i[u].length && ((v[p] = i[u][l]), (p += 1));
                      for (l = 0; l < o; l += 1) for (u = 0; u < r.length; u += 1) l < a[u].length && ((v[p] = a[u][l]), (p += 1));
                      return v;
                    })(o, n);
                  };
                ...
                return (
                  (h.createASCII = function (t, r) {
                    if ((t = t || 1) < 2)
                      return (function (t) {
                        t = void 0 === t ? 2 : t;
                        for (var r, e, n, o, i = +h.getModuleCount() + 2 * t, a = t, u = i - t, f = { "██": "█", "█ ": "▀", " █": "▄", "  ": " " }, c = { "██": "▀", "█ ": "▀", " █": " ", "  ": " " }, l = "", s = 0; s < i; s += 2) {
                  ...
                  (h.renderTo2dContext = function (t, r) {
                    r = r || 2;
                    for (var e = h.getModuleCount(), n = 0; n < e; n++) for (var o = 0; o < e; o++) (t.fillStyle = h.isDark(n, o) ? "black" : "white"), t.fillRect(n * r, o * r, r, r);
                  }),
                  h
                );
              }
              ...
              var r,
                ...
                m =
                  ...
                  (t.getLostPoint = function (t) {
                    ...
                    for (var l = 0, o = 0; o < r; o += 1) for (n = 0; n < r; n += 1) t.isDark(n, o) && (l += 1);
              ...
              function b(n, o) {
                ...
                var r = (function () {
                  ...
                  i = {
                    ...
                    multiply: function (t) {
                      for (var r = new Array(i.getLength() + t.getLength() - 1), e = 0; e < i.getLength(); e += 1) for (var n = 0; n < t.getLength(); n += 1) r[e + n] ^= p.gexp(p.glog(i.getAt(e)) + p.glog(t.getAt(n)));
                      return b(r, 0);
                    },
                    mod: function (t) {
              ...
              function x() {
                ...
                return (
                  ...
                  (t.flush = function () {
                    if ((0 < o && (e(n << (6 - o)), (o = n = 0)), i % 3 != 0)) for (var t = 3 - (i % 3), r = 0; r < t; r += 1) a += "=";
                  }),
                  (t.toString = function () {
                    return a;
                  }),
              ...
              var B,
                ...
                S =
                  ...
                  ((C = {}).getRSBlocks = function (t, r) {
                    ...
                    for (var n, o, i = e.length / 3, a = [], u = 0; u < i; u += 1) for (var f = e[3 * u + 0], c = e[3 * u + 1], l = e[3 * u + 2], s = 0; s < f; s += 1) a.push(((n = l), (o = void 0), ((o = {}).totalCount = c), (o.dataCount = n), o));
                    return a;
                  }),
                  C),
                M = function () {
                ...
                P = function (t, r, e) {
                  for (var n = k(t, r), o = 0; o < r; o += 1) for (var i = 0; i < t; i += 1) n.setPixel(i, o, e(i, o));
                  var a = y();
                  n.write(a);
        ...
        function (t, r, e) {
          ...
          function a(t, r, e) {
            var n, o;
            (n = r),
              (o = e).back && ((n.fillStyle = o.back), n.fillRect(0, 0, o.size, o.size)),
              (function (t, r, e) {
                if (t) {
                  ...
                  for (var u = 0; u < o; u += 1) for (var f = 0; f < o; f += 1) n(t, r, e, i, u, f);
        ...
        function (t, r) {
          ...
          t.exports = {
            ...
            create_canvas: function (t, r) {
              var e = o("canvas", { width: t * r, height: t * r });
              return (e.style.width = "".concat(t, "px")), (e.style.height = "".concat(t, "px")), e;
            },
            canvas_to_img: function (t) {
              var r = o("img", { crossOrigin: "sonu", src: t.toDataURL("image/png") });
              return r;
            },
          };
        },
        function (t, r) {
          t.exports = function (t, r, e, n, o, i) {
            ...
            O
              ? ((p = W), (y = M), (w = A), (m = L), (b = D), (x = _), (B = !F && !N), (C = !Y && !N), (S = !Y && !U), (k = !F && !U) ? p.m(y + x, w) : p.m(y, w), B ? p.l(m - x, w).a(m, w, m, b, x) : p.l(m, w), C ? p.l(m, b - x).a(m, b, y, b, x) : p.l(m, b), S ? p.l(y + x, b).a(y, b, y, w, x) : p.l(y, b), k ? p.l(y, w + x).a(y, w, m, w, x) : p.l(y, w))
              : ((u = W),
                (f = M),
                (c = A),
                (l = L),
        ...
        function (t, r) {
          t.exports = function (t, r) {
            ...
            "label" === h
              ? (function (t, r) {
                  var e = r.size,
                    n = "bold " + 0.01 * r.mSize * e + "px " + r.fontname;
                  (t.strokeStyle = r.back), (t.lineWidth = 0.01 * r.mSize * e * 0.1), (t.fillStyle = r.fontcolor), (t.font = n);
                  var o = t.measureText(r.label).width,
                    i = 0.01 * r.mSize,
                    a = (1 - o / e) * r.mPosX * 0.01 * e,
                    u = (1 - i) * r.mPosY * 0.01 * e + 0.75 * r.mSize * 0.01 * e;
                  t.strokeText(r.label, a, u), t.fillText(r.label, a, u);
                })(t, r)
              : "image" === h && ((e = t), (o = (n = r).size), (i = n.image.naturalWidth || 1), (a = n.image.naturalHeight || 1), (u = 0.01 * n.mSize), (c = (1 - (f = (u * i) / a)) * n.mPosX * 0.01 * o), (l = (1 - u) * n.mPosY * 0.01 * o), (s = f * o), (g = u * o), e.drawImage(n.image, c, l, s, g));
          };
        },
        function (t, r, y) {
          function J(n) {
          ...
          t.exports = function (t, r) {
            var e,
              ...
              d = r.size,
              v = r.mode,
              p = b("svg", { xmlns: w, viewBox: "0 0 ".concat(d, " ").concat(d) });
            return (
              r.back && p.appendChild(b("rect", { x: 0, y: 0, width: d, height: d, fill: r.back })),
              p.appendChild(
                b("path", {
                  d: (function (t, r) {
                    if (!t) return "";
                    ...
                    for (var i, a, u, f, c, l, s, g, h, d, v, p, y, w, m, b, x, k, B, C, S, M, A, L, D, _, z, P, T, j, I, O, R, F, H, N, E, Y, q, U, W, X, V, G = J(e), Q = 0; Q < n; Q += 1)
                      for (var $ = 0; $ < n; $ += 1)
                        (i = t),
                          (a = G),
                          (V = X = W = U = q = Y = E = N = H = F = R = O = I = j = T = P = z = _ = D = L = A = M = S = C = B = k = x = b = m = w = y = p = v = d = h = g = s = l = void 0),
                          (z = (D = (c = $) * (u = o)) + u),
                          (P = (_ = (f = Q) * u) + u),
                          (T = 0.005 * r.rounded * u),
                          (j = i.is_dark),
                          ...
                          (V = j(f, R)),
                          H
                            ? ((m = a), (b = D), (x = _), (k = z), (B = P), (C = T), (M = !E && !q), (A = !W && !q), (L = !W && !V), (S = !E && !V) ? m.m(b + C, x) : m.m(b, x), M ? m.l(k - C, x).a(k, x + C, C) : m.l(k, x), A ? m.l(k, B - C).a(k - C, B, C) : m.l(k, B), L ? m.l(b + C, B).a(b, B - C, C) : m.l(b, B), S ? m.l(b, x + C).a(b + C, x, C) : m.l(b, x))
                            : ((l = a),
                              (s = D),
                              (g = _),
                              (h = z),
              ...
              "label" === v
                ? (function (t, r) {
                    ...
                    (a.strokeStyle = r.back), (a.lineWidth = 0.01 * r.mSize * e * 0.1), (a.fillStyle = r.fontcolor), (a.font = n);
                    var u = a.measureText(r.label).width,
                      f = 0.01 * r.mSize,
                      c = (1 - u / e) * r.mPosX * 0.01 * e,
                      l = (1 - f) * r.mPosY * 0.01 * e + 0.75 * r.mSize * 0.01 * e,
                      s = b("text", { x: c, y: l });
                    Object.assign(s.style, { font: n, fill: r.fontcolor, "paint-order": "stroke", stroke: r.back, "stroke-width": a.lineWidth }), (s.textContent = r.label), t.appendChild(s);
                  })(p, r)
                : "image" === v && ((e = p), (o = (n = r).size), (i = n.image.naturalWidth || 1), (a = n.image.naturalHeight || 1), (u = 0.01 * n.mSize), (c = (1 - (f = (u * i) / a)) * n.mPosX * 0.01 * o), (l = (1 - u) * n.mPosY * 0.01 * o), (s = f * o), (g = u * o), (h = b("image", { href: m(n.image, "src"), x: c, y: l, width: s, height: g })), e.appendChild(h)),
              p
            );
          };
        },
